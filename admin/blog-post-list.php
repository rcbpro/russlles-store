...
$sql = "SELECT * FROM posts WHERE post_type = 'B' ORDER BY date_created DESC";
...
<div id="masthead"><br /><br /><br />
    <div class="content_pad"><h1 class="no_breadcrumbs">Blog Posts</h1></div> <!-- .content_pad -->
</div> <!-- #masthead -->	
<div id="content" class="xgrid">
	<?php if ((isset($_SESSION['blog_success_deleted'])) && ($_SESSION['blog_success_deleted'])):?>
    <div class="success">Selected post deleted successfully !</div>
    <?php unset($_SESSION['blog_success_deleted'])?>
    <?php endif;?><br />
    <div class="x12">
        <div class="font-setting"><h2>&nbsp;</h2></div>
        <div class="cs-setting"><button class="btn btn-small" onClick="javascript: location='blog-post-edit.php?id=0';">New Blog Post</button></div>
            ...
            <?php 
                ...
                <tr> 
                    ...
                    <td align="left" class="smallFont" width="10%"> 
                     <a href="blog-post-edit.php?id=<?=$eachPost['post_id']?>">
                        <img src="../images/edit.png" border="0" title="Edit Blog Post" alt="Edit Blog Post">
                     </a> 
                     <a href="#" onClick="javascript: get_confirmation('Are you sure you wish to delete this post? ','blog-post-delete.php?id=<?=$eachPost['post_id']?>')">
                        <img src="../images/cross.png" border="0" title="Delete Blog Post" alt="Delete Blog Post">
                     </a> 
                   </td>
             </tr> 
             <?php endforeach;?>
