...
$site_id  							= ($site_id==''?"default":$site_id);
//$Config['UserFilesPath'] 			= "http://".$server_path."/microsite/".$site_id."/" ;
$Config['UserFilesPath'] 			= "/microsite/".$site_id."/" ;
$Config['UserFilesAbsolutePath'] 	= $_SERVER["DOCUMENT_ROOT"]."/microsite/".$site_id."/" ;


//$Config['UserFilesPath'] = '/images/fck_upload_files/'.$site_id.'/' ;

// Fill the following value it you prefer to specify the absolute path for the
// user files directory. Useful if you are using a virtual directory, symbolic
// link or alias. Examples: 'C:\\MySite\\userfiles\\' or '/root/mysite/userfiles/'.
// Attention: The above 'UserFilesPath' must point to the same directory.
//$Config['UserFilesAbsolutePath'] = realpath($_SERVER['DOCUMENT_ROOT']."/images/fck_upload_files/default/");
